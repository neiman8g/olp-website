...
export const categories = [
  ...
  { slug: 'voltage-regulators',
    image: '/images/products/voltage-regulators.png', name: 'Voltage Regulators', tagline: 'Power Conditioning & Regulation', description: 'Voltage regulators, isolation transformers, and power conditioners from 3kVA to 2,000kVA. Including ISO-Care and Constant Power series.' },
  { slug: 'power-distribution',
